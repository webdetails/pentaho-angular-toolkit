...
cd "$GH_REPO"
git init
git remote add origin "https://github.com/$GH_USER/$GH_REPO-module.git"
...
git push --force --quiet "https://$GH_TOKEN@github.com/$GH_USER/$GH_REPO-module.git" master:master > /dev/null 2>&1
git push --tags "https://$GH_TOKEN@github.com/$GH_USER/$GH_REPO-module.git"